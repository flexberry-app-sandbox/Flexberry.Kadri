...
CREATE INDEX Indexdb12690da9c19a13f60fc28ce9dc5fcfae00ada9 on Сотрудники (Должность); 
 ...
 ALTER TABLE Анкеты ADD CONSTRAINT FK34edbed41319a51c46184c2f473732ad3b74a327 FOREIGN KEY (Должность) REFERENCES Должности; 
CREATE INDEX Index34edbed41319a51c46184c2f473732ad3b74a327 on Анкеты (Должность); 
